...
-- y el link del video terminado cuando ya está listo.
--
...
-- concepto (lo que le pagás al editor por video, links de material crudo,
-- notas internas, etc). Por eso NO se le da acceso directo a "tasks": se
-- crea una vista que solo expone las columnas seguras, corriendo con los
-- permisos de quien la creó (no los del cliente que consulta) y con el
-- filtro "es tuya" ya adentro de la vista — así ni con las herramientas de
-- desarrollador del navegador un cliente puede pedir la tabla completa.
