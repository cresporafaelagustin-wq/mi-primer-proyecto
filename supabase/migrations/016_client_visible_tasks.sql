...
-- y los links de material crudo, guión, editado y referencia de cada una.
--
...
-- concepto (lo que le pagás al editor por video, notas internas, etc). Por
-- eso NO se le da acceso directo a "tasks": se crea una vista que solo
-- expone las columnas seguras, corriendo con los permisos de quien la creó
-- (no los del cliente que consulta) y con el filtro "es tuya" ya adentro de
